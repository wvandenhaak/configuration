...
use IceCake\AppConfigurator\Service\Loader\DataSource\YamlDataSource;
...
class YamlDataSourceTest extends TestCase
{
    ...
    {
        $this->filename = dirname(dirname(dirname(__DIR__))) . '/data/files/test-configuration.yaml';
    }
    ...
    public function testThrowsLoadingException(): void
    {
        ...
        $nonExcistingFile = dirname(dirname(dirname(__DIR__))) . '/data/files/non-existing-file.yaml';
